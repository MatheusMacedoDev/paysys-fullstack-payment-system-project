...
public class DataContext : DbContext
{
    ...
    protected void seedTransferData(ModelBuilder modelBuilder)
    {
        var transferId = new Guid("216a0718-b9bf-4ad2-84ad-7e125ead9e10");

        modelBuilder.Entity<Transfer>(type =>
        {
            type.HasData(
                [
                    new Transfer(
                        transferId: transferId,
                        transferAmount: 2469.93,
                        transferDateTime: new DateTime(2025, 1, 16, 16, 56, 38, 553, DateTimeKind.Utc).AddTicks(4845),
                        transferStatusId: new Guid("5e55e212-6419-4c21-b9b6-6fa65e636978"),
                        transferCategoryId: new Guid("bc7e2062-9aad-4e59-afdb-52733ac514e4"),
                        senderUserId: new Guid("8499d00f-fac1-4296-9b2c-d2143cbf1563"),
                        receiverUserId: new Guid("46121131-1507-4470-83ea-dd0439c51b4c")
                    )
                ]
            );

            type.OwnsOne(s => s.TransferDescription)
                .HasData([
                    new { TransferId = transferId, DescriptionText = "Notebook ASUS VivoBook Go 15, AMD RYZEN 5 7520U, 8GB, 256GB SSD, KeepOS, Tela 15,6 pol FHD, Mixed Black - E1504FA-NJ731" },
                ]
            );
        });
    }
