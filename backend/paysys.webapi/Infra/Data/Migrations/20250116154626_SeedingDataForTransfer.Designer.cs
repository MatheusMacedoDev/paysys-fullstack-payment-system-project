...
namespace paysys.webapi.Infra.Data.Migrations
{
    ...
    [Migration("20250116154626_SeedingDataForTransfer")]
    partial class SeedingDataForTransfer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("paysys.webapi.Domain.Entities.TransferCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TransferCategoryId = new Guid("9bba9f3e-234f-4ec5-aac3-d2e99f46a59a")
                        },
                        new
                        {
                            TransferCategoryId = new Guid("2e6c6eaf-5d25-4241-b1b0-7d3433824861")
                        },
                        new
                        {
                            TransferCategoryId = new Guid("384b4ec9-f5ac-406e-b2a2-52733dcc73de")
                        },
                        new
                        {
                            TransferCategoryId = new Guid("bc7e2062-9aad-4e59-afdb-52733ac514e4")
                    ...
                    b.OwnsOne("paysys.webapi.Domain.ValueObjects.Description", "TransferDescription", b1 =>
                        {
                            ...
                            b1.HasData(
                                ...
                                {
                                    TransferId = new Guid("216a0718-b9bf-4ad2-84ad-7e125ead9e10"),
                                    DescriptionText = "Notebook ASUS VivoBook Go 15, AMD RYZEN 5 7520U, 8GB, 256GB SSD, KeepOS, Tela 15,6 pol FHD, Mixed Black - E1504FA-NJ731"
                                });
                        });
